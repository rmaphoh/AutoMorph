...
def test_net(data_path, batch_size, num_workers, device, dataset_train, dataset_test, image_size, job_name, threshold, checkpoint_mode, mask_or=True, train_or=False, results_dir=''):
    ...
    dir_checkpoint_1="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,24)
    dir_checkpoint_2="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,26)
    dir_checkpoint_3="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,28)
    dir_checkpoint_4="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,30)
    dir_checkpoint_5="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,32)
    dir_checkpoint_6="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,34)
    dir_checkpoint_7="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,36)
    dir_checkpoint_8="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,38)
    dir_checkpoint_9="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,40)
    dir_checkpoint_10="{}train_on_{}/{}_savebest_randomseed_{}/".format(gv.M2_V_model,dataset_train,job_name,42)
