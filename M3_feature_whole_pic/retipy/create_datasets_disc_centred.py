...
Artery_PATH = '../../Results/M2/artery_vein/disc_centred_artery_skeleton'
Vein_PATH = '../../Results/M2/artery_vein/disc_centred_vein_skeleton'
Binary_PATH = '../../Results/M2/binary_vessel/disc_centred_binary_skeleton'

for filename in sorted(glob.glob(os.path.join(Binary_PATH, '*.png'))):
    
    try:
        segmentedImage = retina.Retina(None, filename, store_path='../../Results/M2/binary_vessel/disc_centred_binary_process')
        ...
        FD_binary,VD_binary,Average_width, t2, t4, td = tortuosity_measures.evaluate_window(window, CONFIG.pixels_per_window, CONFIG.sampling_size, CONFIG.r_2_threshold,store_path='../../Results/M2/binary_vessel/disc_centred_binary_process/')
        #print(window.tags)
...
for filename in sorted(glob.glob(os.path.join(Artery_PATH, '*.png'))):
    ...
    try:
        ...
        segmentedImage = retina.Retina(None, filename,store_path='../../Results/M2/artery_vein/disc_centred_artery_process')
        window_sizes = [912]
        window = retina.Window(
            segmentedImage, window_sizes[-1], min_pixels=CONFIG.pixels_per_window)
        FD_binary,VD_binary,Average_width, t2, t4, td = tortuosity_measures.evaluate_window(window, CONFIG.pixels_per_window, CONFIG.sampling_size, CONFIG.r_2_threshold,store_path='../../Results/M2/artery_vein/disc_centred_artery_process/')
        #print(window.tags)
...
for filename in sorted(glob.glob(os.path.join(Vein_PATH, '*.png'))):
    ...
    try:
        segmentedImage = retina.Retina(None, filename,store_path='../../Results/M2/artery_vein/disc_centred_vein_process')
        window_sizes = [912]
        window = retina.Window(
            segmentedImage, window_sizes[-1], min_pixels=CONFIG.pixels_per_window)
        FD_binary,VD_binary,Average_width, t2, t4, td = tortuosity_measures.evaluate_window(window, CONFIG.pixels_per_window, CONFIG.sampling_size, CONFIG.r_2_threshold,store_path='../../Results/M2/artery_vein/disc_centred_vein_process/')
        #print(window.tags)
...
Data4stage2.to_csv('../../Results/M3/Disc_centred/Disc_Measurement.csv', index = None, encoding='utf8')
